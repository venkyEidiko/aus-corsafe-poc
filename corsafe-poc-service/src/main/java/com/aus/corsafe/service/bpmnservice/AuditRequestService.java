...
public class AuditRequestService {
    ...
    public void GettingVariableAndSettingVariable(final ActivatedJob job){
        ...
        ProcessDetails processDetails = ProcessDetails.builder()
                ...
                .postalCode(Long.parseLong((String) job.getVariable("postalCode")))
                .phoneNumber((long)((int)job.getVariable("phoneNumber")))
    ...
    public void chargeCalculation(final ActivatedJob job){
